...
class Compiler
{
	...
	public static function preProcess(Bundle $bundle)
	{
		...
		$newContents = '// do not edit this file - it was generated - edit ./bundle.ts.tpl' . PHP_EOL . PHP_EOL . $rendered;// . self::renderReferences($bundle);
	...
	/**
	 * does not work with the current implementation of typescript
	 *
	 * @param Bundle $bundle
	 * @return string
	 */
	private static function renderReferences(Bundle $bundle)
	{
		$ret = '';
		$references = ReferenceManager::getSortedReferences($bundle);
		foreach($references as $reference) {
			$ret .= '/// <reference path=\'' . $reference . '\' />' . PHP_EOL;
		}
		return $ret;
	}
